...
(defun jd:c++-mode-map ()
  ...
  (define-key c++-mode-map (kbd "<C-e>") 'c-mark-function)
  (define-key c++-mode-map (kbd "<C-i>") 'c-beginning-of-defun-hl)
  (define-key c++-mode-map (kbd "<C-k>") 'c-end-of-defun-hl)
  (define-key c++-mode-map (kbd "<C-M-i>") 'c-forward-conditional)
  (define-key c++-mode-map (kbd "<C-M-k>") 'c-backward-conditional)
  (define-key c++-mode-map (kbd "<C-x> <C-M-i>") 'c-up-conditional)
