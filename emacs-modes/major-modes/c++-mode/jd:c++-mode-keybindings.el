...
(defun jd:c++-mode-map ()
  ...
  (define-key c++-mode-map (kbd "<C-c> <C-i>") 'c-backward-conditional)
  (define-key c++-mode-map (kbd "<C-c> <C-k>") 'c-forward-conditional)
  (define-key c++-mode-map (kbd "<C-c> i") 'c-up-conditional)
  (define-key c++-mode-map (kbd "<C-c> k") 'c-down-conditional)
