...
(define-key ivy-minibuffer-map (kbd "<C-i>") 'ivy-scroll-down-command)
(define-key ivy-minibuffer-map (kbd "<C-k>") 'ivy-scroll-up-command)
...
(define-key ivy-minibuffer-map (kbd "<C-M-o>") 'ivy-alt-done)
(define-key ivy-minibuffer-map (kbd "<C-M-k>") 'ivy-next-history-element)
(define-key ivy-minibuffer-map (kbd "<C-M-u>") 'counsel-up-directory)
