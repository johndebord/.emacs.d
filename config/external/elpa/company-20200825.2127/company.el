...
;;; Aug. 28th, 2020
;;; Upgraded to company-20200825.2127.
;;;
;;; Modified `company-search-map` to work with `meta-prefix-char` being `nil`;
;;; not sure why I made it `nil`; was probably screwing up my keybinds.
...
;;; Original modification.
;;; Aug, 27th, 2020
;;; Updated to company-20200825.2127.
;;;
;;; Doc buffer manipulation; can't exactly what this changes. I think it just
;;; forces the doc buffer to appear in the current window.
