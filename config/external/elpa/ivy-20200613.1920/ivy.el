         ...
         (res
          (cond
           ...
           (t
            ...
            ;;; Updated:
            ;;; Jun. 13th, 2020
            ;;; Upgraded to ivy-20200613.1920.
            ;;;
            ;;; Fixes last buffer usage inconsistencies.
            (select-window (ivy--get-window ivy-last) t) ;; jd
...
;;; Upgraded to ivy-20200613.1920
;;;
;;; My ideal functionality is for `counsel-switch-buffer' to show the current
;;; buffer upon activation of this command.
;;;###autoload
(defun ivy-switch-buffer ()
  ...
  (ivy-read "Switch to buffer: " #'internal-complete-buffer
            ...
            :preselect (buffer-name (current-buffer)) ;; jd
