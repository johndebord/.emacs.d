(require 'jd:cmake-mode.el (concat jd:external-prefix "cmake-mode/jd:cmake-mode.elc"))
...
(require 'jd:idle-highlight-mode.el (concat jd:external-prefix "idle-highlight-mode/jd:idle-highlight-mode.elc"))
