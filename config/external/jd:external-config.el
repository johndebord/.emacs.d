(require 'jd:auto-complete.el (concat jd:external-prefix "auto-complete/jd:auto-complete.elc"))
...
(require 'jd:popup.el (concat jd:external-prefix "popup/jd:popup.elc"))
