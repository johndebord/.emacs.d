...
the first time printing, a prompt shall appear asking if you would like to print
out a specific value for the prints during this cycle; upon
...
(defvar jd:cpp-print-string nil
  "Incrementally-numbered print string that could include additional information
based on the value of `jd:cpp-print-value`; upon `jd:cpp-print-delete-prints`,
this variable shall be reset to `nil`.")

(defvar jd:cpp-print-count 0
  "Number of total prints that have been printed; upon
`jd:cpp-print-delete-prints`, all prints that have been accounted for shall be
deleted.")

(defun jd:cpp-print-add-print ()
  "Print a string for quickly debugging code. The location of these prints shall
be saved in registers, so that a call to `jd:cpp-print-delete-prints` will know
where to go for the deletion of the prints in the buffer."
  (interactive)
  (read-only-mode 0)
